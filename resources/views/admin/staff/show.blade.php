    ...
    <div class="admin-package-info clearfix">
      ...
      <div class="admin-package-info-content-right">
        <div class="admin-package-info-content-image">
          <img src="/images/{{$staff->photo ? $staff->photo : 'https://gitlab.kitware.com/assets/no_group_avatar-4a9d347a20d783caee8aaed4a37a65930cb8db965f61f3b72a2e954a0eaeb8ba.png'}}" alt="">
        </div>
      </div>
